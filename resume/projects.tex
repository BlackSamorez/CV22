...
\begin{cventries}
  ...
  \cventry
    {\href{https://huggingface.co/docs/transformers/main/model_doc/llama\#overview}{\url{huggingface.co/docs/transformers/main/model_doc/llama\#overview}}} % Empty position
