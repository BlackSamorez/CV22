...
\begin{cventries}
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Authored a first-author paper on \textit{LLM Compression}. Refer to the \textit{Publications} section for more details}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {July 2023 - September 2023}
    {
      \begin{cvitems}
        ...
        \item {Authored a first-author first-author paper on \textit{Correlated Quantization}. Refer to the \textit{Publications} section for more details}
      \end{cvitems}
    }
